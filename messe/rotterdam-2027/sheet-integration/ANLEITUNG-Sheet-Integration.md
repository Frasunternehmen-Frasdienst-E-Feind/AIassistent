...
> es legt nur den Tab „Messe-Aufgaben" an und hängt beim Import Zeilen unten an „Aufgaben" an.
...
3. Prüfen, dass der Haupt-Tab wirklich **„Aufgaben"** heißt. Falls nicht: im Skript oben `AUFGABEN_TAB` anpassen.
4. Zurück ins Sheet, Seite **neu laden**. Es erscheint das Menü **„Messe-Cockpit"**.
...
6. Optional, um die Cockpit-Aufgaben zu übernehmen: **„Messe-Cockpit › Cockpit-Aufgaben importieren (einmalig)"**.
   ...
   erneuter Lauf legt keine Dubletten an). Verantwortliche danach bei Bedarf im Tab „Aufgaben" umverteilen.
