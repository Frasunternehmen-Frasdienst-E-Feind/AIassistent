...
with db.get_conn() as conn:
    ...
    conn.executemany(
        ...
        [
            ("EF-FD 101", "VW", "Crafter", "Transporter", "2022-03-15", 68400, d(12), d(45), 70000, "verfuegbar"),
            ("EF-FD 102", "Skoda", "Octavia Combi", "PKW", "2023-06-01", 31200, d(300), None, 45000, "verfuegbar"),
            ("EF-FD 103", "Ford", "Transit", "Transporter", "2019-11-20", 142000, d(-5), d(-2), None, "werkstatt"),
            ("EF-FD 104", "Mercedes", "Sprinter", "Transporter", "2021-01-10", 98750, d(120), d(20), 100000, "verfuegbar"),
    ...
    conn.executemany(
        ...
        [
            ("Anna Beispiel", "Vertrieb", "B", d(-30), "0361 000-11"),
            ("Bernd Muster", "Fertigung", "B, C1", d(-190), "0361 000-12"),
            ("Claudia Test", "Marketing", "B", None, "0361 000-13"),
        ],
    )
    conn.executemany(
